...
const ProductCard = ({product}) => {
  ...
  return (
    ...
    <div className="card h-100">
        ...
        <img className="card-img-top rounded mx-auto d-block mt-2" src={product.images}  alt="..."  style={{ width:'200px',height: '250px' }} />
        ...
        <div className="card-footer pb-3 pt-0 border-top-0 bg-transparent">
            <div className="text-center">
            <button className={isInCart() ? "btn btn-danger mt-auto" : "btn btn-outline-success mt-auto"} onClick={handleClick}>
